package com.test.sample.Dictionary;
...
public class WordChainAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        if (!(args.length>=0&& args.length<=2)){
        	System.out.println("Please enter two words only  ");
        }
         
            
            System.out.println("Please enter the starting word: " + args[0]);
            beginWord = args[0];
            System.out.println("Please enter the target word: " + args[1]);
            endWord = args[1];
   ...
   /* public static String getWord(Scanner in) {
    ...
    public List<List<String>> getWordChains(String beginWord, String endWord, Set<String> dictionary) {
        ...
        res= dfs(beginWord, endWord, neighbourNodes, distance, solution, res);
...
//                int curDistance = distance.get(cur);
                ...
                for(String neighbour : neighbours) {
                	...
                	if (neighbourNodes.get(cur)!=null)
    ...
    private List<List<String>> dfs(String cur, String end, HashMap<String, ArrayList<String>> neighbourNodes,
    ...
    public Set<String> getDictionary(String beginWord) {
        ...
        String fileName = "C:\\Users\\balamurugan\\JDK8SAMPLE\\Dictionary\\src\\main\\resource\\test.txt";
        try {
